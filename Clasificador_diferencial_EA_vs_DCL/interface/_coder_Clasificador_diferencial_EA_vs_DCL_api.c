 ...
 *
 * _coder_Clasificador_diferencial_EA_vs_DCL_api.c
 *
...
#include "_coder_Clasificador_diferencial_EA_vs_DCL_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Clasificador_diferencial_EA_vs_DCL",/* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Clasificador_diferencial_EA_vs_DCL_api(const mxArray * const prhs[1],
...
void Clasificador_diferencial_EA_vs_DCL_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Clasificador_diferencial_EA_vs_DCL_xil_terminate();
}

void Clasificador_diferencial_EA_vs_DCL_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Clasificador_diferencial_EA_vs_DCL_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Clasificador_diferencial_EA_vs_DCL_api.c) */
