 ...
 *
 * _coder_Clasificador_diferencial_EA_vs_DFT_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Clasificador_diferencial_EA_vs_DFT",/* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Clasificador_diferencial_EA_vs_DFT_api(const mxArray * const prhs[1],
...
void Clasificador_diferencial_EA_vs_DFT_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Clasificador_diferencial_EA_vs_DFT_xil_terminate();
}

void Clasificador_diferencial_EA_vs_DFT_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Clasificador_diferencial_EA_vs_DFT_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Clasificador_diferencial_EA_vs_DFT_api.c) */
